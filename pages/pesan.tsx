...
const PesanPage: React.FC = () => {
  const orderOptions = [
    {
      id: 'whatsapp-berau',
      name: 'WhatsApp Berau',
      description: 'Chat langsung dengan tim Berau',
      icon: WhatsAppIcon,
      color: 'from-green-500 to-emerald-600',
      bgColor: 'from-green-50 to-emerald-50',
      textColor: 'text-green-700',
      link: 'https://wa.me/6281234567890?text=Halo, saya ingin order dari Zatiaras Juice Berau',
      branch: 'Berau'
    },
    {
      id: 'whatsapp-samarinda',
      name: 'WhatsApp Samarinda',
      description: 'Chat langsung dengan tim Samarinda',
      icon: WhatsAppIcon,
      color: 'from-green-500 to-emerald-600',
      bgColor: 'from-green-50 to-emerald-50',
      textColor: 'text-green-700',
      link: 'https://wa.me/6281234567891?text=Halo, saya ingin order dari Zatiaras Juice Samarinda',
      branch: 'Samarinda'
    },
    {
      id: 'gofood-berau',
      name: 'GoFood Berau',
      description: 'Order via GoFood Berau',
      icon: GoFoodIcon,
      color: 'from-red-500 to-red-600',
      bgColor: 'from-red-50 to-red-50',
      textColor: 'text-red-700',
      link: 'https://gofood.co.id/merchant/zatiaras-juice-berau',
      branch: 'Berau'
    },
    {
      id: 'gofood-samarinda',
      name: 'GoFood Samarinda',
      description: 'Order via GoFood Samarinda',
      icon: GoFoodIcon,
      color: 'from-red-500 to-red-600',
      bgColor: 'from-red-50 to-red-50',
      textColor: 'text-red-700',
      link: 'https://gofood.co.id/merchant/zatiaras-juice-samarinda',
      branch: 'Samarinda'
    },
    {
      id: 'grab-berau',
      name: 'Grab Berau',
      description: 'Order via Grab Berau',
      icon: GrabIcon,
      color: 'from-green-600 to-green-700',
      bgColor: 'from-green-50 to-green-50',
      textColor: 'text-green-700',
      link: 'https://food.grab.com/id/en/restaurant/zatiaras-juice-berau',
      branch: 'Berau'
    },
    {
      id: 'grab-samarinda',
      name: 'Grab Samarinda',
      description: 'Order via Grab Samarinda',
      icon: GrabIcon,
      color: 'from-green-600 to-green-700',
      bgColor: 'from-green-50 to-green-50',
      textColor: 'text-green-700',
      link: 'https://food.grab.com/id/en/restaurant/zatiaras-juice-samarinda',
      branch: 'Samarinda'
    }
  ];
  ...
  return (
    <>
      <Head>
        <title>Pesan Sekarang - Zatiaras Juice | WhatsApp, GoFood, Grab</title>
        <meta name="description" content="Pesan Zatiaras Juice melalui WhatsApp, GoFood, atau Grab. Pilih cabang terdekat dan platform pesanan favorit Anda." />
        <meta name="keywords" content="pesan zatiaras juice, whatsapp order, gofood, grab, delivery berau, delivery samarinda" />
        <link rel="canonical" href="https://zatiarasjuice.com/pesan" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Pesan Sekarang - Zatiaras Juice | WhatsApp, GoFood, Grab" />
        <meta property="og:description" content="Pesan Zatiaras Juice melalui WhatsApp, GoFood, atau Grab. Pilih cabang terdekat dan platform pesanan favorit Anda." />
        <meta property="og:url" content="https://zatiarasjuice.com/pesan" />
        <meta property="og:type" content="website" />
      </Head>

      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50">
        <Header currentPath="/pesan" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Pilih platform pesanan favorit Anda dan cabang terdekat. 
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <h3 className={`text-xl font-bold ${option.textColor}`}>{option.name}</h3>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        <span className={`text-sm font-semibold px-3 py-1 rounded-full ${option.textColor} bg-opacity-20`}>
                          {option.branch}
                        </span>
                      </div>
                      ...
                      <motion.div
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`inline-flex items-center gap-3 bg-gradient-to-r ${option.color} text-white px-6 py-4 rounded-2xl font-bold hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl`}
                      >
