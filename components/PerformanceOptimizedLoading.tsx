...
interface PerformanceOptimizedLoadingProps {
  size?: 'sm' | 'md' | 'lg' | 'xl';
...
const PerformanceOptimizedLoading: React.FC<PerformanceOptimizedLoadingProps> = ({
  size = 'md',
  variant = 'spinner',
  text,
  className = '',
...
export default PerformanceOptimizedLoading;
