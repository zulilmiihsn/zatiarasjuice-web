    ...
    >
      ...
      <div className="p-4">
        ...
        <motion.button
          ...
          className="w-full bg-primary-500 text-white py-3 rounded-lg font-medium text-sm hover:bg-primary-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {isAddingToCart ? (
            <>
        ...
        <div className="mt-3 grid grid-cols-2 gap-2">
          <motion.a
            ...
            className="bg-green-500 text-white py-2 px-3 rounded-lg text-xs font-medium hover:bg-green-600 transition-all duration-200 text-center"
          >
            WhatsApp
          </motion.a>
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-orange-500 text-white py-2 px-3 rounded-lg text-xs font-medium hover:bg-orange-600 transition-all duration-200 text-center"
          >
            GoFood
          </motion.a>
        </div>
