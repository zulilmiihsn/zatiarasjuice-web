...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`group relative bg-white rounded-2xl shadow-soft hover:shadow-strong transition-all duration-300 overflow-hidden ${className}`}
    >
      {/* Featured Badge */}
      {product.is_featured && (
        <motion.div
      ...
      <div className="p-6">
        ...
        <motion.button
          ...
          className="w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white py-3 rounded-xl font-medium hover:shadow-glow transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
        >
          {isAddingToCart ? (
            <motion.div
              animate={{ rotate: 360 }}
